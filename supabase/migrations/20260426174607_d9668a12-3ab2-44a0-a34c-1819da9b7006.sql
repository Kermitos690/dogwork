...
BEGIN
  ...
  IF inv_record_id IS NOT NULL AND inv_record_educator IS NOT NULL THEN
    INSERT INTO public.client_links (coach_user_id, client_user_id, status)
    VALUES (inv_record_educator, NEW.id, 'active')
