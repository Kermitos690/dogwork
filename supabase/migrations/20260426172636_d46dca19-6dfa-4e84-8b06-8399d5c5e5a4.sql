CREATE TABLE IF NOT EXISTS public._p0_test_results (
  id serial PRIMARY KEY, test_name text, status text, message text, ran_at timestamptz DEFAULT now()
);
...
BEGIN
  ...
  -- A: pas de charte
  BEGIN
    INSERT INTO courses (educator_user_id, title, description, price_cents, max_participants, duration_minutes, is_public, approval_status, requires_dogwork_payment, level)
    VALUES (v_coach,'P0_TEST_A_no_charter','Cours basique',5000,5,60,true,'approved',true,'beginner');
  ...
  BEGIN
    INSERT INTO courses (educator_user_id, title, description, price_cents, max_participants, duration_minutes, is_public, approval_status, requires_dogwork_payment, level)
    VALUES (v_coach,'P0_TEST_B_no_module','Cours basique',5000,5,60,true,'approved',true,'beginner');
  ...
  BEGIN
    INSERT INTO courses (educator_user_id, title, description, price_cents, max_participants, duration_minutes, is_public, approval_status, requires_dogwork_payment, level)
    VALUES (v_coach,'P0_TEST_C_twint','Paiement TWINT direct',5000,5,60,true,'approved',true,'beginner');
  ...
  BEGIN
    INSERT INTO courses (educator_user_id, title, description, price_cents, max_participants, duration_minutes, is_public, approval_status, requires_dogwork_payment, level)
    VALUES (v_coach,'P0_TEST_D_zero_cap','Cours basique',5000,0,60,true,'approved',true,'beginner');
  ...
  -- E: pas paiement DogWork
  BEGIN
    INSERT INTO courses (educator_user_id, title, description, price_cents, max_participants, duration_minutes, is_public, approval_status, requires_dogwork_payment, level)
    VALUES (v_coach,'P0_TEST_E_no_pay','Cours basique',5000,5,60,true,'approved',false,'beginner');
  ...
  BEGIN
    INSERT INTO courses (educator_user_id, title, description, price_cents, max_participants, duration_minutes, is_public, approval_status, requires_dogwork_payment, level)
    VALUES (v_coach,'P0_TEST_F_clean','Cours propre sur les bases du clic',5000,5,60,true,'approved',true,'beginner');
  ...
  BEGIN
    INSERT INTO courses (educator_user_id, title, description, price_cents, max_participants, duration_minutes, is_public, approval_status, requires_dogwork_payment, level)
    VALUES (v_coach,'P0_TEST_G_restricted','Cours basique',5000,5,60,true,'approved',true,'beginner');
