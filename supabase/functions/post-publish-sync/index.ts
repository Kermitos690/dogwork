...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const featureCatalog = [
      ...
      { code: "education_plan", label: "Plan éducatif IA", credits_cost: 8, model: "google/gemini-2.5-pro", is_active: true, cost_estimate_avg_usd: 0.02, cost_estimate_min_usd: 0.01, cost_estimate_max_usd: 0.04, margin_target: 3.0, description: "Plan éducatif complet généré par IA" },
      { code: "behavior_analysis", label: "Analyse comportementale", credits_cost: 13, model: "google/gemini-2.5-pro", is_active: true, cost_estimate_avg_usd: 0.015, cost_estimate_min_usd: 0.008, cost_estimate_max_usd: 0.03, margin_target: 3.0, description: "Analyse comportementale détaillée" },
      { code: "behavior_summary", label: "Résumé comportemental", credits_cost: 5, model: "google/gemini-2.5-flash", is_active: true, cost_estimate_avg_usd: 0.005, cost_estimate_min_usd: 0.002, cost_estimate_max_usd: 0.01, margin_target: 3.0, description: "Résumé comportemental synthétique" },
      { code: "dog_profile_analysis", label: "Analyse de profil chien", credits_cost: 13, model: "google/gemini-2.5-pro", is_active: true, cost_estimate_avg_usd: 0.01, cost_estimate_min_usd: 0.005, cost_estimate_max_usd: 0.02, margin_target: 3.0, description: "Analyse détaillée du profil d'un chien" },
      ...
      { code: "adoption_plan", label: "Plan de suivi post-adoption IA", credits_cost: 15, model: "google/gemini-2.5-pro", is_active: true, cost_estimate_avg_usd: 0.015, cost_estimate_min_usd: 0.008, cost_estimate_max_usd: 0.03, margin_target: 3.0, description: "Plan de suivi post-adoption généré par IA" },
