...
- Prefer local/Lovable validation and targeted manual checks while the project has no required GitHub-hosted CI.
...
- Supabase migrations, Edge Function deployment, Stripe operations, production maintenance, and data enrichment must remain manual and explicitly confirmed.

## Scheduled and one-shot automation

- Prefer Supabase cron, Lovable Cloud, or the hosting platform's job system over GitHub runners.
