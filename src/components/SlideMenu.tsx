  ...
  const userSections: MenuSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Crédits IA", icon: Coins, path: "/credits" },
  ...
  const coachSections: MenuSection[] = [
    {
      ...
      items: [
        ...
        { label: "Refuges partenaires", icon: Building2, path: "/coach/shelter-animals" },
        { label: t("menu.myCourses"), icon: GraduationCap, path: "/coach/courses" },
        { label: "Bibliothèque coach", icon: BookOpen, path: "/coach/exercises" },
        ...
        { label: "Ma page publique", icon: Globe, path: "/ma-page-publique" },
        { label: "Messages", icon: MessageSquare, path: "/coach/messages" },
        { label: "Outils IA Pro", icon: Sparkles, path: "/coach/ai" },
        { label: "Parrainages", icon: Gift, path: "/coach/referrals" },
        { label: "Conformité", icon: ShieldCheck, path: "/coach/compliance" },
        { label: "Abonnement éducateur", icon: CreditCard, path: "/coach/subscription" },
        { label: "Crédits IA", icon: Coins, path: "/coach/credits" },
        { label: "Paramètres pro", icon: Settings, path: "/coach/settings" },
        { label: "Support", icon: MessageSquare, path: "/coach/support" },
      ],
    },
  ];
  ...
  const shelterSections: MenuSection[] = [
    {
      ...
      items: [
        ...
        { label: "Outils IA Refuge", icon: Sparkles, path: "/shelter/ai" },
        { label: "Ma page publique", icon: Globe, path: "/ma-page-publique" },
        { label: "Abonnement refuge", icon: CreditCard, path: "/shelter/subscription" },
        { label: "Crédits IA", icon: Coins, path: "/shelter/credits" },
        { label: "Paramètres refuge", icon: Settings, path: "/shelter/settings" },
      ],
    },
  ];
